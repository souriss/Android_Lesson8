package ru.mirea.lednevadd.yandexmaps;
...
import ru.mirea.lednevadd.yandexmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements UserLocationObjectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapview.getMap().move(
                new CameraPosition(new Point(57.70085242007605, 39.75863965085656), 11.0f, 0.0f, 0.0f),
